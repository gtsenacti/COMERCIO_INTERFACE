...
namespace appComercio
{
    public partial class frmCadastroUsuario : Form
    {
        ...
        private void dgvCadastroUsuario_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtCadastroNome.Text = linha.Cells["NomeUsuario"].Value?.ToString();
            txtCadastroSetor.Text = linha.Cells["SetorUsuario"].Value?.ToString();
            txtCadastroSenha.Text = linha.Cells["SenhaUsuario"].Value?.ToString();
        }
        ...
        private async void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtCadastroNome.Text) ||
                ...
                string.IsNullOrWhiteSpace(txtCadastroSetor.Text))
            {
        ...
        private async void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(usuarioAtualizado.NomeUsuario) ||
                string.IsNullOrWhiteSpace(usuarioAtualizado.SetorUsuario) ||
